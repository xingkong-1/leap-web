<template>
  <div id="Tv">
    ...
    <div class="user-ty-type">
      <li>
        <router-link to="" id="handpick" @click.native="clickVideo($event)" :class="{'typeColor':typeColour === '电影精选'}">
          电影精选
        </router-link>
      </li>
      <li>
        <router-link to="" id="overseas" @click.native="clickVideo($event)" :class="{'typeColor':typeColour === '院线大片'}">
          院线大片
        </router-link>
      </li>
      <li>
        <router-link to="" id="network" @click.native="clickVideo($event)" :class="{'typeColor':typeColour === '自制电影'}">自制电影
        </router-link>
      </li>
      <li>
        <router-link to="" id="annual" @click.native="clickVideo($event)" :class="{'typeColor':typeColour === '动作'}">动作
        </router-link>
      </li>
      <li>
        <router-link to="" id="praise" @click.native="clickVideo($event)" :class="{'typeColor':typeColour === '喜剧'}">喜剧
        </router-link>
      </li>
      <li>
        <router-link to="" id="free" @click.native="clickVideo($event)" :class="{'typeColor':typeColour === '科幻'}">科幻
        </router-link>
      </li>
      <li>
        <router-link to="" @click.native="clickVideo($event)" :class="{'typeColor':typeColour === '犯罪'}">犯罪</router-link>
      </li>
      <li>
        <router-link to="" @click.native="clickVideo($event)" :class="{'typeColor':typeColour === '爱情'}">爱情</router-link>
      </li>
      <li>
        <router-link to="" @click.native="clickVideo($event)" :class="{'typeColor':typeColour === '独播'}">独播</router-link>
      </li>
      <li>
        <router-link to="" @click.native="clickVideo($event)" :class="{'typeColor':typeColour === '预告片'}">预告片</router-link>
      </li>
    </div>
    <!--    主体-->
            ...
            filtrateVideo: function (event) {
                ...
                switch (filtrateValue) {
                    case '电影精选':
                        ...
                        break;
                    case '院线大片':
                        this.filtrateData.rank = '院线大片';
                        break;
                    case '自制电影':
                        this.filtrateData.rank = '自制电影';
                        break;
                    case '好评':
