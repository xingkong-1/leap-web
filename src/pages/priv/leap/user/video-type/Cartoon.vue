<template>
  <div id="Movie">
    ...
    <div class="user-ty-type">
      <li>
        <router-link to="" id="handpick" @click.native="clickVideo($event)" :class="{'typeColor':typeColour === '动漫精选'}">
          动漫精选
        </router-link>
      </li>
      <li>
        <router-link to="" id="overseas" @click.native="clickVideo($event)" :class="{'typeColor':typeColour === '国漫'}">
          国漫
        </router-link>
      </li>
      <li>
        <router-link to="" id="network" @click.native="clickVideo($event)" :class="{'typeColor':typeColour === '日漫'}">日漫
        </router-link>
      </li>
      <li>
        <router-link to="" id="annual" @click.native="clickVideo($event)" :class="{'typeColor':typeColour === '经典'}">经典
        </router-link>
      </li>
      <li>
        <router-link to="" id="praise" @click.native="clickVideo($event)" :class="{'typeColor':typeColour === '治愈'}">治愈
        </router-link>
      </li>
      <li>
        <router-link to="" id="free" @click.native="clickVideo($event)" :class="{'typeColor':typeColour === '热血'}">热血
        </router-link>
      </li>
      <li>
        <router-link to="" @click.native="clickVideo($event)" :class="{'typeColor':typeColour === '青春'}">青春</router-link>
      </li>
      <li>
        <router-link to="" @click.native="clickVideo($event)" :class="{'typeColor':typeColour === '战斗'}">战斗</router-link>
      </li>
      <li>
        <router-link to="" @click.native="clickVideo($event)" :class="{'typeColor':typeColour === '恶搞'}">恶搞</router-link>
      </li>
      <li>
        <router-link to="" @click.native="clickVideo($event)" :class="{'typeColor':typeColour === '魔幻'}">魔幻</router-link>
      </li>
      <li>
        <router-link to="" @click.native="clickVideo($event)" :class="{'typeColor':typeColour === '科幻'}">科幻
        </router-link>
      </li>
      <li>
        <router-link to="" @click.native="clickVideo($event)" :class="{'typeColor':typeColour === '推理'}">推理
        </router-link>
      </li>
    </div>
    <!--    主体-->
    ...
    export default {
        ...
        methods: {
            ...
            ifColumnPush: function (typeValue) {
                if (typeValue === '动漫精选' || typeValue === '海外剧') {
